...
const MyProfile = () => {
  ...
  const { getUserProfile, backendUrl, token } = useContext(AppContext)
  ...
  const updateUserProfileData = async () => {
    try {
      ...
      const { data } = await axios.post(`${backendUrl}/api/user/update-profile`, fromData, { headers: { Authorization: `Bearer ${token}` } })
